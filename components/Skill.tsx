...
function Skill(props: any) {
  return (
    <div className="relative flex cursor-pointer group">
      ...
      />
      <div className="absolute z-0 w-12 h-12 transition duration-300 ease-in-out rounded-full opacity-0 group-hover:bg-white group-hover:opacity-80 md:w-16 md:h-16">
